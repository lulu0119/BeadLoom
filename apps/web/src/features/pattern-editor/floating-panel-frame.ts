...
export const CHAT_DEFAULT_HEIGHT = 256;

export const PALETTE_MIN_WIDTH = 240;
export const PALETTE_MIN_HEIGHT = 200;
export const PALETTE_DEFAULT_WIDTH = 300;
export const PALETTE_DEFAULT_HEIGHT = 420;

export function clampPanelFrame(frame: PanelFrame, bounds: PanelBounds, limits: PanelSizeLimits): PanelFrame {
