/**
 * Shared selection chrome for “active drawing color” in Used-in-chart pills and palette swatches.
 * Always use `border-2` so inactive and active states share the same stroke weight (only hue changes).
 */
